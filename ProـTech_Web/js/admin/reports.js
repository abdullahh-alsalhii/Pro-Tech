...
const Render_list_to_table = async ({ from, to, search }) => {
    var reports_list;
    try {
...
const socket = async () => {
    ...
    const give_to_tec_func = () => {
        var id_input = give_to_tec_button.parentElement.querySelector("input[type=hidden]");
        var tec_id_input = give_to_tec_button.parentElement.querySelector(".forms input");
    ...
    const close_report_func = () => {
        var id_input = close_report_button.parentElement.querySelector("input[type=hidden]");
